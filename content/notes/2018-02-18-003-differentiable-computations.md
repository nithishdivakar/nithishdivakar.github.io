...
<!--<embed src="{{site.dev-images}}/2018-02-18-003-differentiable-computations.pdf" width="500" height="500"  type="application/pdf" frameborder="0" allowfullscreen>-->
...
Forward computation as a Constrained optimisation problem {#forward-computation-as-a-constrained-optimisation-problem .unnumbered}
=========================================================
